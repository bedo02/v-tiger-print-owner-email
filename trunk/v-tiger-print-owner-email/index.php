...
if(isset($action) && isset($module))
{
	...
	if(ereg("^Save", $action) ||
		...
		//pdf configurator     
		ereg("^pdfconfig",$action) ||
		ereg("^UpdatePDFSettings",$action) ||
		ereg("^pdfsettings",$action) ||
	...
	if($action == 'Save')
	{
        ...
        if(($module == 'Users' || $module == 'Home' || $module == 'uploads') or ($module == 'Settings' && $action == 'UpdatePDFSettings'))
        {
