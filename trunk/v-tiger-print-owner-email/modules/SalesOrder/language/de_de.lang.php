...
// crm-now, hinzugefügt, um Anzeigen in der Aktivitätenhistorie zu übersetzen
'Call'=>'Anruf',
'Meeting'=>'Meeting',
'Task'=>'Aufgabe',
'Planned'=>'geplant',
...
//crm-now: fehlende Einträge für Berichte
'Tax Type'=>'Steuertyp',
...
'LBL_PDF_CONFIGURATOR_DESC'=>'Hier können Sie die PDF Ausgabe für Ihre Verkaufsbestellungen verändern.',
...
'LBL_PDF_DATE'=>'Welches Datum soll im Kopf der PDF Ausgabe benutzt werden?',
'today'=>'heute',
'created'=>'erstellt',
'modified'=>'geändert',
...
'LBL_OWNER'=>'Wollen Sie den Namen des Bearbeiters im Kopf ausgeben?',
'LBL_OWNER_PH'=>'Wollen Sie die Telefonnummer des Bearbeiters im Kopf ausgeben?',
'LBL_CUSTSIGN'=>'Wollen Sie das Kundenzeichen im Kopf ausgeben?',
'LBL_PRINT_FOOTER'=>'Wollen Sie die Angaben im Fuß ausgeben?',
'LBL_PRINT_FOOTERPAGE'=>'Wollen Sie im Fuß die Bestell- und Seitennummer ausgeben?',
'LBL_PDFSAVE'=>'speichern',
'LBL_PDFSUBJECT'=>'gespeichertes PDF',
'LBL_SO_EXPORT_PDF'=>'als PDF exportieren',
