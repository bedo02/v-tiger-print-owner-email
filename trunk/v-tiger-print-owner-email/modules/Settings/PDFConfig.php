...
if (isset ($_REQUEST[frommodule])) {
	if ($_REQUEST[frommodule]== 'Settings') $frommodul = 'Settings';
	else $frommodul = array('frommodule'=>$_REQUEST['frommodule'],'recordid'=>$_REQUEST['recordid']);
}
else $frommodul = 'Settings';

$smarty = new vtigerCRM_Smarty;

//get language file for PDF output
$pdf_language_array_quotes = return_module_language_pdf($current_language, 'Quotes');
$module_language_array_quotes = return_module_language($current_language, 'Quotes');
$pdf_language_array_invoices = return_module_language_pdf($current_language, 'Invoice');
$module_language_array_invoices = return_module_language($current_language, 'Invoice');
$pdf_language_array_so = return_module_language_pdf($current_language, 'SalesOrder');
$module_language_array_so = return_module_language($current_language, 'SalesOrder');
$pdf_language_array_po = return_module_language_pdf($current_language, 'PurchaseOrder');
$module_language_array_po = return_module_language($current_language, 'PurchaseOrder');
...
//decide the view
$smarty->assign("MODULEVIEW", $frommodul);
