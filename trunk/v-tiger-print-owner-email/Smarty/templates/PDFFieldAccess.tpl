...
<script type="text/javascript" src="include/js/tab-view.js"></script>
...
<br>
<form enctype="multipart/form-data" action="index.php?module=Settings&action=UpdatePDFSettings&parenttab=Settings" id="pdfsettings" name="pdfsettings" onsubmit="return checkvalues(pdfsettings); window.close();" method="post" >
	...
	<input type="hidden" name="parenttabstart" value="Sales">
	<input type="hidden" name="entryid" value="{$MODULEVIEW.recordid}">
	        ...
	        <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
				...
				<div align=center>
					...
					<table border=0 cellspacing=0 cellpadding=5 width="100%" class="settingsSelUITopLine">
							<tr>
								<td width=50 rowspan=2 valign="top"><img src="{$IMAGE_PATH}pdfconfig.gif" alt="{$MOD.LBL_MODULE_NAME}" width="48" height="48" border=0 title="{$MOD.LBL_MODULE_NAME}"></td>
								<td colspan=2 class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{$MOD.LBL_SETTINGS}</a> > {$MOD.LBL_PDFCONFIGURATOR} </b></td>
																			...
																			<tr>
																				<td valign="top"  width="80%" class="smalltxt">{$PDFMODULLANGUAGEQUOTES.LBL_PDF_DATE}
																					<select name="Quotes_dateused_qv" class="detailedViewTextBox"  style="width:20%;" id="Quotes_dateused_qv" {$CHANGEPERMISSION.Quotes.dateused}>
																						{html_options values=$DATEUSED.Quotes output= $DATEUSEDNAME selected=$DATEUSEDSELECTED}
																					</select>
																				</td>
																				{if $MODULEVIEW=='Settings'}
																				<td class="smalltxt"  width="20%" align="right">
										...
										<table>
											...
											{if $MODULEVIEW=='Settings'} 
												<td class="small" align='left' nowrap width="100%">
													<input class="crmButton small save" id="saveg" name="saveg" title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}"  type="submit" action="index.php?module=Settings&action=UpdatePDFSettings&parenttab=Settings"   value=" {$APP.LBL_SAVE_BUTTON_LABEL}  ">&nbsp;
								...
								<td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
									...
									<div align=center>
																			...
																			<tr>
																				<td valign="top"  width="80%" class="smalltxt">{$PDFMODULLANGUAGESO.LBL_PDF_DATE}
																					<select name="SalesOrder_dateused_sv" class="detailedViewTextBox"  style="width:20%;" id="SalesOrder_dateused_sv" {$CHANGEPERMISSION.SalesOrder.dateused}>
																						{html_options values=$DATEUSED.SalesOrder output= $DATEUSEDNAME selected=$DATEUSEDSELECTED}
																					</select>
																				</td>
																				{if $MODULEVIEW=='Settings'}
																				<td class="smalltxt"  width="20%" align="right">
										...
										<table>
											...
											{if $MODULEVIEW=='Settings'} 
												<td class="small" align='left' nowrap width="100%">
													<input class="crmButton small save" id="saveso" name="saveso" title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}"  type="submit" action="index.php?module=Settings&action=UpdatePDFSettings&parenttab=Settings"   value=" {$APP.LBL_SAVE_BUTTON_LABEL}  ">&nbsp;
								...
								<td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
									...
									<div align=center>
																			...
																			<tr>
																				<td valign="top"  width="80%" class="smalltxt">{$PDFMODULLANGUAGEPO.LBL_PDF_DATE}
																					<select name="PurchaseOrder_dateused_pv" class="detailedViewTextBox"  style="width:20%;" id="PurchaseOrder_dateused_pv" {$CHANGEPERMISSION.PurchaseOrder.dateused}>
																						{html_options values=$DATEUSED.PurchaseOrder output= $DATEUSEDNAME selected=$DATEUSEDSELECTED}
																					</select>
																				</td>
																				{if $MODULEVIEW=='Settings'}
																				<td class="smalltxt"  width="20%" align="right">
										...
										<table>
											...
											{if $MODULEVIEW=='Settings'} 
												<td class="small" align='left' nowrap width="100%">
													<input class="crmButton small save" id="savepo" name="savepo" title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}"  type="submit" action="index.php?module=Settings&action=UpdatePDFSettings&parenttab=Settings"   value=" {$APP.LBL_SAVE_BUTTON_LABEL}  ">&nbsp;
