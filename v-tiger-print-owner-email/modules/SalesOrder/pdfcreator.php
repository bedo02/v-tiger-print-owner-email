...
function createpdffile ($idnumber,$purpose='', $path='',$current_id='') {
	...
	//select language file
		switch($pdf_config_details[pdflang])
		{
			case "en_us":
				...
				break;
			case "de_de":
				include("modules/SalesOrder/language/de_de.lang.pdf.php");
				$language = "DE";
				break;
			case "pl_pl":
				include("modules/SalesOrder/language/pl_pl.lang.pdf.php");
				$language = "PL";
				break;
			default:
				include("modules/SalesOrder/language/en_us.lang.pdf.php");
	...
	// send pdf with mail
		...
		{
			case "EN":
				$pdf->Output('storage/SalesOrder.pdf','F'); //added file name to make it work in IE, also forces the download giving the user the option to save
				break;
			case "DE":
