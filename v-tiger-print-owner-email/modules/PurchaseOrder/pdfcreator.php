...
function createpdffile ($idnumber,$purpose='', $path='',$current_id='') {
	...
	//select language file
		switch($pdf_config_details[pdflang])
		{
			case "en_us":
				...
				break;
			case "de_de":
				include("modules/PurchaseOrder/language/de_de.lang.pdf.php");
				$language = "DE";
				break;
			case "pl_pl":
				include("modules/PurchaseOrder/language/pl_pl.lang.pdf.php");
				$language = "PL";
				break;
			default:
				include("modules/PurchaseOrder/language/en_us.lang.pdf.php");
	...
	$ownerphone = $pdf_config_details['owneremail'];
	...
	// send pdf with mail
		switch($language)
		{
			case "EN":
				...
				break;
			case "DE":
				$pdf->Output('storage/Einkaufsbestellung.pdf','F'); //added file name to make it work in IE, also forces the download giving the user the option to save
				break;
			case "PL":
				$pdf->Output('storage/PurchaseOrder.pdf','F'); //added file name to make it work in IE, also forces the download giving the user the option to save
				break;
